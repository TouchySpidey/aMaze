...
if (!isset($_SESSION['username'])) {
	...
	} else { //specie di registrazione
		# basterebbe aggiungerlo in coda al file, ma i json finiscono con una } quindi leggo il file come un array, pusho in array e stampo l'array nel file
		$utenti[$_SESSION['username']] = [];
		$pointer = fopen('./data/users.json', 'w');
		fwrite($pointer, json_encode($utenti, JSON_PRETTY_PRINT));
		fclose($pointer);
	}
?>
<html>
	<head>
		...
		<!--In questo .js c'è una funzione per mostrare e nascondere i dettagli partita (classe "collassato")-->
			...
			<div class="row">
				...
				?>
					...
					<div class="list-group">
						...
						<div class="list-group-item collassato">
