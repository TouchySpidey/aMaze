...
<html>
	...
	<body>
		...
		<?php
		// questa pagina ha un form che si richiama fino a che la condizione qui sotto non è soddisfatta. Solo a quel punto la sessione verrà impostata e si verrà reindirizzati alla creazione del labirinto
		/** * condizione:
			* post non vuota (l'utente non ha scritto /newconf-dim.php a tradimento)
			* il numero di righe è specificato
			* il numero di colonne pure
			* questi due numeri hanno valori numerici
		*/
